...
func main() {
	...
	var protectedBranches = flag.String("protectedBranches", "develop,master,main,preview,review,stage,staging", "comma seperated list of substrings to mark a namespace as protected from deletion")
